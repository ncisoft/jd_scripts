...
##### 拉库：
ql repo https://github.com/ncisoft/JD_tencent_scf.git "src" "test|new|test_index" "^jd[^_]|USER|sendNotify|sign_graphics_validate|JDJR|JDSign|ql|getEnv.js|jdCookies.js|sendNotify.js"
